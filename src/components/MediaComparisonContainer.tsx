  ...
  return (
    <div className={styles.bgParent}>
      ...
      <SizeMediumIconLeftFalse
        ...
        sizeMediumIconLeftFalseTop="calc(50% + 287.5px)"
      ...
      <div className={styles.content}>
        <img className={styles.maskedIcon} alt="" src="/masked-icon7.svg" />
      ...
      <InputAWAvataraEnabled
        ...
        inputAWAvataraEnabledTop="calc(50% - 168.5px)"
      ...
      <div className={styles.dividerParent}>
        ...
        <div className={styles.imageGroup}>
          ...
          <div className={styles.div5}>公開日 : 2022/12/20</div>
        </div>
      </div>
      <div className={styles.div6}>主なユーザー属性</div>
      ...
      <div className={styles.rectangleContainer}>
        ...
        <div className={styles.div7}>シーズン限定メニュー</div>
...
export default MediaComparisonContainer;
